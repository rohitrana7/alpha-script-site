	...
	createDb() {
		const pages = [
			...
			},
			{
				...
				developer: 'Alphascript Inc.',
				developerlink: 'alphascript.in',
			},
			{
				id: 7,
				name: 'header',
				tagline: 'BEYOND DIGITAL TRANSFORMATION',
				title:
					'Alphascript is focussed on providing the most innovative and best-in-class digital products and data solutions!',
